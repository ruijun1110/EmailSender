...
namespace EmailTool
{
    ...
    public class ReadConfig
    {
        ...
        public ReadConfig(Sender sender, Recipients recipients, EmailContent emailContent)
        {
            if (sender == null)
            {
                throw new Exception("Sender object is null. ReadConfig class cannot be initialized.");
            }
            if (recipients == null)
            {
                throw new Exception("Receivers object is null. ReadConfig class cannot be initialized.");
            }
            if (emailContent == null)
            {
                throw new Exception("Email object is null. ReadConfig class cannot be initialized.");
            }
